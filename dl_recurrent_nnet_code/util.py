...
def get_robert_frost():
    ...
    current_idx = 2
    sentences = []
    path = '/Users/congshanzhang/Documents/Office/machine learning/dl_recurrent_nnet(code)'
    for line in open(path+'/robert_frost.txt'):
        line = line.strip()
        if line:
            ...
            for t in tokens:
                if t not in word2idx:
                    ...
                    current_idx += 1
                idx = word2idx[t]
                sentence.append(idx)   # for each line, we create a list of word indices
